      ...
      // 后续检查
      {
        ...
        children: [
          // 查看
          {
            path: 'view/:id',
            component: () =>
              import('@/views/auditManagement/track/show'),
            name: 'trackView',
            meta: { title: 'trackView', noCache: true, id: 29 }
          }
        ]
      },
      // 审计通知
      {
        ...
        children: [
          // 查看
          {
            path: 'view/:id',
            component: () =>
              import('@/views/auditManagement/auditNotice/show'),
            name: 'auditNoticeView',
            meta: { title: 'auditNoticeView', noCache: true, id: 30 }
          }
        ]
      }
    ]
