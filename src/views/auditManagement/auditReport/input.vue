...
-->
<template>
  <div class="audit-report-input-container">
      ...
      <el-card>
        ...
        <div class="card-content">
          ...
          <div class="content-header">
            <div>尊敬的联社领导:</div>
            <div class="header-content indent">根据《 {{ headerData.programme }} 》( {{ headerData.number }} 号文件)文件精神，xx支行领导高度重视，
          ...
          <div>
            <h3>一、组织实施情况</h3>
            <div class="indent">
              <h4>(一) 成立领导小组: {{ implement.user }}</h4>
            </div>
            <div class="indent">
              <h4>(二) 制定专项检查方案: {{ implement.programme }}</h4>
            </div>
            <div>
              <h4>&emsp;&emsp;(三) 开展自查工作:</h4>
              <div>
                <!--实施稽核的依据-->
                <span>实施稽核的依据</span>
                <hr>
          ...
          <div>
            ...
            <tinymce
              :height="300"
              v-model="auditReportData.basicInfo"/>
          </div>
          ...
          <div>
            ...
            <tinymce
              :height="300"
              v-model="auditReportData.reason"/>
          </div>
          ...
          <div>
            ...
            <h4>问责:</h4>
            <div>
              <el-row v-for="(item,index) in accountability" :gutter="10" :key="index">
          ...
          <div>
            ...
            <tinymce
              :height="300"
              v-model="auditReportData.plan"/>
          </div>

          <br>
          <div class="submit-button">
            <el-button :loading="buttonLoading" type="primary" size="small" @click="submitEditAuditReport('draft')">保存为草稿</el-button>
            <el-button :loading="buttonLoading" type="success" size="small" @click="submitEditAuditReport('publish')">保存并发布</el-button>
          </div>
...
import { getAuditReport, editAuditReport, programmeGet, getDraft, getConfirmation, getRectifyReport, getAccountability } from '@/api/auditManagement'
export default {
