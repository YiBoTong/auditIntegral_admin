  ...
  <el-card v-loading="loading" class="audit-report-input-container">
    ...
    <div class="card-content">
      ...
      <div>
        <h3>二、基本情况</h3>
        <br>
        <tinymce :height="300" v-model="auditReportData.basicInfo"/>
      </div>
      ...
      <div>
        <h3>四、问题形成的原因</h3>
        <br>
        <tinymce :height="300" v-model="auditReportData.reason"/>
      </div>
      ...
      <div>
        <h3>六、下一步工作措施</h3>
        <br>
        <tinymce :height="300" v-model="auditReportData.plan"/>
      </div>

      <br>
      <div align="center">
        <el-button :loading="buttonLoading" type="primary" size="small" @click="submitEditAuditReport('draft')">保存为草稿</el-button>
        <el-button :loading="buttonLoading" size="small" @click="submitEditAuditReport('publish')">保存并发布</el-button>
      </div>
    </div>
  </el-card>
</template>
